...
# pintos -v -k -T 60 -m 20   --fs-disk=10 -p tests/userprog/exec-readc:exec-read -p ../../tests/userprog/sample.txt:sample.txt -p tests/userprog/child-read:child-read -- -q   -f run exec-read
